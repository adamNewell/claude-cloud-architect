#!/bin/bash
# Deterministic scan for the iot-core pattern pack.
# Usage: bash patterns/iot-core/scan.sh <repo-path> <session-id> <db-path>
set -e
...
echo "{\"ok\":true,\"pack\":\"iot-core\",\"tags_written\":$TAG_COUNT}"
